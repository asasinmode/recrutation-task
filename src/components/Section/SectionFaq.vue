<template>
	<section class="grid gap-x-8 gap-y-1 bg-[#f5f5f5] px-[--container-px] py-4 text-[#293632] md:grid-flow-col md:grid-rows-[repeat(2,_min-content)] md:grid-cols-3 md:py-6">
		<h3 class="text-3 font-600 leading-[1.25]">
			How can I win?
		</h3>
		<p class="mb-2 text-[0.625rem] leading-[1.6] md:mb-0">
		...
		<p class="text-[0.625rem] leading-[1.6]">
